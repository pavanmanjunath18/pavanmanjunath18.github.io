...
export default function Resume() {
  return (
    <section id="resume" className="py-20 md:py-28 bg-[#080808] relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] bg-[#FF8000]/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-display font-bold text-white mb-4">Resume</h2>
            ...
            <div className="p-8 md:p-10">
                ...
                <div className="grid sm:grid-cols-2 gap-2.5">
                  {highlights.map((item) => (
                    <div key={item} className="flex items-start gap-2.5 text-sm text-gray-300">
                      <CheckCircle size={14} className="text-[#FF8000] mt-0.5 flex-shrink-0" />
                      <span>{item}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  ...
                  className="group flex-1 flex items-center justify-center gap-2.5 px-6 py-4 rounded-xl bg-gradient-to-r from-[#FF8000] via-[#FF6B00] to-[#FFB347] text-white font-semibold text-sm hover:opacity-90 transition-all duration-200 shadow-lg shadow-[#FF8000]/25 glow hover:scale-[1.02] relative overflow-hidden"
                >
                ...
                <a
                  ...
                  className="flex-1 flex items-center justify-center gap-2.5 px-6 py-4 rounded-xl glass border border-white/10 text-gray-300 font-semibold text-sm hover:text-white hover:border-[#FF8000]/30 transition-all duration-200 hover:scale-[1.02]"
                >
                  <Eye size={18} />
                  View in Browser
                </a>
